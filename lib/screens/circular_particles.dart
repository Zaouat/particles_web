...
class _CircularParticleState extends State<CircularParticle>{
  ...
  void initState() {
    ...
    controller =
        AnimationController(duration: const Duration(seconds: 10), vsync: this as TickerProviderStateMixin);
  ...
  onTapGesture(double tapdx, double tapdy) {
    awayAnimationController = AnimationController(
        duration: widget.awayAnimationDuration, vsync: this as TickerProviderStateMixin);
